...
<div class="row justify-content-sm-center">
  <div class="col-sm-4 mt-3 mt-md-0">
    <img src="{{ '/assets/img/e4-test1.png' | relative_url }}" alt="Testing for Ease of Use" class="img-fluid rounded z-depth-1" style="object-fit: contain; height: 300px; width: 100%;">
  </div>
  <div class="col-sm-4 mt-3 mt-md-0">
    <img src="{{ '/assets/img/e4-test2.png' | relative_url }}" alt="Testing for rotation" class="img-fluid rounded z-depth-1" style="object-fit: contain; height: 300px; width: 100%;">
  </div>
</div>
<div class="caption">
